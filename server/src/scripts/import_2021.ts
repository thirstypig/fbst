...
// Period dates for 2021
const PERIOD_DATES_2021 = [
  { p: 1, start: '2021-04-01', end: '2021-04-24' },
  { p: 2, start: '2021-04-25', end: '2021-05-22' },
  { p: 3, start: '2021-05-23', end: '2021-06-12' },
  { p: 4, start: '2021-06-13', end: '2021-07-10' },
  { p: 5, start: '2021-07-11', end: '2021-08-07' },
  { p: 6, start: '2021-08-08', end: '2021-09-04' },
  { p: 7, start: '2021-09-05', end: '2021-10-03' },
];
...
async function import2021() {
  const year = 2021;
  const leagueId = 1;
  const archiveDir = path.join(__dirname, '../data/archive/2021');
  ...
  for (const dateInfo of PERIOD_DATES_2021) {
  ...
  const standingsPath = path.join(archiveDir, 'season_standings_2021.csv');
  if (fs.existsSync(standingsPath)) {
      console.log(`\n  📊 Processing season_standings_2021.csv...`);
  ...
  console.log(`   - Periods: ${PERIOD_DATES_2021.length}`);
