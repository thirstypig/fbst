...
// Period dates for 2022 from period_dates_2022.csv
const PERIOD_DATES_2022 = [
  { p: 1, start: '2022-04-07', end: '2022-04-23' },
  { p: 2, start: '2022-04-24', end: '2022-05-21' },
  { p: 3, start: '2022-05-22', end: '2022-06-11' },
  { p: 4, start: '2022-06-12', end: '2022-07-09' },
  { p: 5, start: '2022-07-10', end: '2022-08-06' },
  { p: 6, start: '2022-08-07', end: '2022-09-03' },
  { p: 7, start: '2022-09-04', end: '2022-10-05' },
];
...
async function import2022() {
  const year = 2022;
  const leagueId = 1;
  const archiveDir = path.join(__dirname, '../data/archive/2022');
  ...
  // Check both reference file AND all years in database
  ...
  for (const dateInfo of PERIOD_DATES_2022) {
  ...
  const standingsPath = path.join(archiveDir, 'season_standings_2022.csv');
  if (fs.existsSync(standingsPath)) {
      console.log(`\n  📊 Processing season_standings_2022.csv...`);
      ...
      for (const row of records) {
        await prisma.historicalStanding.create({
          data: {
            ...
            // Map specific category scores if present in CSV
  ...
  console.log(`   - Periods: ${PERIOD_DATES_2022.length}`);
