...
const costComparison = {
  ...
  scope: [
    "70,700+ lines of TypeScript (strict mode)",
    ...
    <div className="px-4 py-6 md:px-6 md:py-10 max-w-5xl mx-auto space-y-12">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-[var(--lg-text-secondary)]">
          ...
          49 sessions, 70,700+ lines of TypeScript, and an estimated 85 million+ AI tokens.
        </p>
