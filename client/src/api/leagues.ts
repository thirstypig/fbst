...
export async function getMyRoster(leagueId: number): Promise<{ team: any; roster: any[] }> {
    return fetchJsonApi<{ team: any; roster: any[] }>(`${API_BASE}/leagues/${leagueId}/my-roster`);
}
